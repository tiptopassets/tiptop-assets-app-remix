...
export class PartnerIntegrationService {
  private static platforms: PartnerPlatform[] = [
    // Airbnb Partners (now separated by type) - Updated to match database
    {
      ...
      referralLink: 'https://www.airbnb.com/rp/tiptopa2?p=stay&s=67&unique_share_id=ace0bce8-693b-4430-95a4-d790ae402679',
    ...
    },
    {
      ...
      referralLink: 'https://www.airbnb.com/rp/tiptopa2?p=experience&s=67&unique_share_id=31f4b412-ab23-4086-83b1-2c42610fa78d',
      logoUrl: 'https://www.airbnb.com/favicon.ico',
      priority: 8,
      setupTime: '1-2 hours',
    ...
    },
    {
      ...
      referralLink: 'https://www.airbnb.com/rp/tiptopa2?p=service&s=67&unique_share_id=831440f2-8e02-447e-9235-bbf4d928ca8b',
      logoUrl: 'https://www.airbnb.com/favicon.ico',
      priority: 7,
      setupTime: '1-2 hours',
    ...
    // Internet/Bandwidth Partners
    {
      ...
      referralLink: 'https://join.honeygain.com/TIPTO9E10F',
    ...
    // Event Space Partners - INCLUDING PEERSPACE FOR COWORKING SPACES
    {
      ...
      earningRange: { min: 100, max: 500 },
      referralLink: 'https://www.peerspace.com/claim/gr-jdO4oxx4LGzq',
    ...
    },
    {
      ...
      referralLink: 'https://app.grass.io/register?referral=nmGzz16893s4u-R',
