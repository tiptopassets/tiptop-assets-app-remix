...
const AssetIcons = () => {
  ...
  return (
    <div className="relative w-full h-[400px] flex items-center justify-center">
      ...
      >
        <div className="w-16 h-16 bg-gradient-to-br from-yellow-300 to-amber-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-yellow-400/50">
          ...
          <div className="absolute inset-0 rounded-xl bg-gradient-to-tr from-white/25 to-transparent pointer-events-none"></div>
        </div>
      </motion.div>
      ...
      >
        <div className="w-16 h-16 bg-gradient-to-br from-green-300 to-green-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-green-400/50">
          <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <div className="w-16 h-16 bg-gradient-to-br from-purple-300 to-purple-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-purple-400/50">
          <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 5C7.03 5 2.73 8.51 1 12C2.73 15.49 7.03 19 12 19C16.97 19 21.27 15.49 23 12C21.27 8.51 16.97 5 12 5Z" fill="url(#wifiGradient)" stroke="#7E22CE" strokeWidth="1.5" />
            <circle cx="12" cy="12" r="3" fill="#7E22CE" />
            <path d="M2 12C3.73 15.49 7.56 18 12 18C16.44 18 20.27 15.49 22 12" stroke="url(#wifiStrokeGradient)" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M20 8C17.83 6.1 15.01 5 12 5C8.99 5 6.17 6.1 4 8" stroke="url(#wifiStrokeGradient)" strokeWidth="1.5" strokeLinecap="round" />
            <defs>
              <linearGradient id="wifiGradient" x1="1" y1="12" x2="23" y2="12" gradientUnits="userSpaceOnUse">
                <stop stopColor="#C084FC" />
                <stop offset="1" stopColor="#8B5CF6" />
              </linearGradient>
              <linearGradient id="wifiStrokeGradient" x1="2" y1="12" x2="22" y2="12" gradientUnits="userSpaceOnUse">
      ...
      >
        <div className="w-16 h-16 bg-gradient-to-br from-blue-300 to-blue-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-blue-400/50">
          <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <div className="w-16 h-16 bg-gradient-to-br from-amber-300 to-yellow-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-amber-400/50">
          <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Swimming Pool Icon */}
      <motion.div 
        className="glass-icon absolute top-[30%] left-10"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 1.3, duration: 0.5 }}
      >
        <div className="w-16 h-16 bg-gradient-to-br from-sky-300 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-sky-400/50">
          <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Car Icon */}
      <motion.div 
        className="glass-icon absolute bottom-10 right-[25%]"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 1.5, duration: 0.5 }}
      >
        <div className="w-16 h-16 bg-gradient-to-br from-indigo-300 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-indigo-400/50">
          <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
