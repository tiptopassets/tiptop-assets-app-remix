  ...
  return (
    <div className="relative w-full h-[400px] flex items-center justify-center">
      ...
      <div className="absolute animate-float">
        <img 
          src="/lovable-uploads/3e3c1510-cb1a-418c-959a-91e09ff8940b.png" 
          alt="3D House"
      ...
      {/* Solar Panel Icon */}
      <div className="glass-effect absolute top-10 right-[35%] p-3 rounded-2xl animate-float" style={{animationDelay: "0.5s"}}>
      ...
      {/* Garden Icon */}
      <div className="glass-effect absolute top-[25%] right-10 p-3 rounded-2xl animate-float" style={{animationDelay: "1s"}}>
      ...
      {/* Wifi Icon */}
      <div className="glass-effect absolute bottom-[25%] left-10 p-3 rounded-2xl animate-float" style={{animationDelay: "1.5s"}}>
      ...
      {/* Parking Icon */}
      <div className="glass-effect absolute bottom-[15%] right-10 p-3 rounded-2xl animate-float" style={{animationDelay: "2s"}}>
      ...
      {/* Storage Icon */}
      <div className="glass-effect absolute bottom-10 left-[35%] p-3 rounded-2xl animate-float" style={{animationDelay: "2.5s"}}>
